...
if version >= 700
  hi CursorLine    guibg=#404040 ctermbg=234
...
hi StatusLine 	   guifg=#ffffff guibg=#ff9800 gui=none ctermfg=253 ctermbg=238
...
hi String 		   guifg=#f0f0a0 gui=none ctermfg=148
